package com.nutrisportclone.checkout.ui
...
class CheckoutViewModel(
    ...
    init {
        ...
        viewModelScope.launch {
            customerRepository.getCustomerFlow().collectLatest { data ->
                if (data.isSuccess()) {
    ...
    fun updatePhoneNumber(value: String) {
        screenState = screenState.copy(
            phoneNumber = PhoneNumber(
                dialCode = screenState.country.dialCode, number = value
            )
        )
    }
            ...
            viewModelScope.launch {
                paypalApi.beginCheckout(
                    ...
                    shippingAddress = ShippingAddress(
                        addressLine1 = screenState.address ?: "Unknown address", city = screenState.city ?: "Unknown city", state = screenState.country.name, postalCode = screenState.postalCode.toString(), countryCode = screenState.country.code
                    ),
                    onSuccess = onSuccess,
                    onError = onError
                )
